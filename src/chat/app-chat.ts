...
const OPENCLAW_TOOL_CONTEXT = [
  ...
  "- When Dietrich says idea, impulse, thought, maybe, possibility, or wants to document/sort something loose, createInitiative with type = idea. Ideas are not time-bound.",
